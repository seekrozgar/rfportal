                                ...
                                <div class="row g-3 mt-2">
                                    <div class="col-md-4">
                                        <div class="form-check payment-option">
                                            <input class="form-check-input" type="radio" name="gateway" value="paypal"
                                                id="paypal">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-check payment-option">
                                            <input class="form-check-input" type="radio" name="gateway" value="jazzcash"
                                                id="jazzcash">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-check payment-option">
                                            <input class="form-check-input" type="radio" name="gateway" value="easypaisa"
                                                id="easypaisa">

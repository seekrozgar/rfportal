{{-- resources/views/admin/faqs/categories/create.blade.php --}}
            ...
            <div class="card shadow-sm border-0">
                <div class="card-header bg-white py-3 border-bottom d-flex justify-content-between align-items-center flex-wrap gap-2">
                    <h5 class="mb-0 fw-bold">
                        <i class="fas fa-plus-circle me-2 text-primary"></i> Add FAQ Category
                    </h5>
                ...
                <div class="card-body">
                    <form action="{{ route('admin.faq-categories.store') }}" method="POST" id="categoryForm" novalidate>
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                                    value="{{ old('name') }}" placeholder="e.g. General, Technical, Support" required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" name="icon" class="form-control @error('icon') is-invalid @enderror"
                                        value="{{ old('icon', 'fas fa-folder') }}" placeholder="e.g. fas fa-question-circle" id="iconInput">

                    ...
                    <div class="form-group">
                        ...
                        <select id="job_shift_id" name="job_shift_id"
                            ...
                            @foreach($jobShifts as $id => $name)
                                <option value="{{ $id }}" {{ old('job_shift_id') == $id ? 'selected' : '' }}>{{ $name }}</option>
                            @endforeach
                        </select>
                        @error('job_shift_id')
                            <div class="text-danger small mt-1">{{ $message }}</div>
                    ...
                    <div class="form-group">
                        ...
                        <select id="career_level_id" name="career_level_id"
                            ...
                            @foreach($careerLevels as $id => $name)
                                <option value="{{ $id }}" {{ old('career_level_id') == $id ? 'selected' : '' }}>{{ $name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select id="functional_area_id" name="functional_area_id"
                            ...
                            @foreach($functionalAreas as $id => $name)
                                <option value="{{ $id }}" {{ old('functional_area_id') == $id ? 'selected' : '' }}>{{ $name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select id="degree_level_id" name="degree_level_id"
                            ...
                            @foreach($degreeLevels as $id => $name)
                                <option value="{{ $id }}" {{ old('degree_level_id') == $id ? 'selected' : '' }}>{{ $name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select id="gender_id" name="gender_id"
                            ...
                            @foreach($genders as $id => $name)
                                <option value="{{ $id }}" {{ old('gender_id') == $id ? 'selected' : '' }}>{{ $name }}</option>
                            @endforeach
                        </select>
                        @error('gender_id')
                            <div class="text-danger small mt-1">{{ $message }}</div>
                    ...
                    <div class="form-group">
                        ...
                        <select id="marital_status_id" name="marital_status_id"
                            ...
                            @foreach($maritalStatuses as $id => $name)
                                <option value="{{ $id }}" {{ old('marital_status_id') == $id ? 'selected' : '' }}>{{ $name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select id="salary_period_id" name="salary_period_id"
                            ...
                            @foreach($salaryPeriods as $id => $name)
                                <option value="{{ $id }}" {{ old('salary_period_id') == $id ? 'selected' : '' }}>{{ $name }}
                                </option>
                            @endforeach
                        </select>

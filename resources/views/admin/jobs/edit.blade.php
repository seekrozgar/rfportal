...
@section('content')
    <div class="admin-card">
        ...
        <form method="POST" action="{{ route('admin.jobs.update', $job) }}" class="admin-form">
            @csrf
            @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <select id="experience_level_id" name="experience_level_id"
                            ...
                            @foreach($experienceLevels as $id => $name)
                                <option value="{{ $id }}" {{ old('experience_level_id', $job->experience_level_id) == $id ? 'selected' : '' }}>{{ $name }}</option>
                            @endforeach
                        </select>
            ...
            <!-- ✅ ADVERTISEMENT IMAGE (with preview) -->
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">

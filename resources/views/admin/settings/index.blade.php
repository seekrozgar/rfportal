                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.settings.update') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <ul class="nav nav-tabs settings-tabs" id="settingsTabs" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" data-bs-toggle="tab" data-bs-target="#tab-ads" type="button"
                                        role="tab">
                                        <i class="fas fa-ad"></i> Ads
                                    </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" data-bs-toggle="tab" data-bs-target="#tab-captcha"
                                        type="button" role="tab">
                                        <i class="fas fa-shield-alt"></i> Captcha
                                    </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" data-bs-toggle="tab" data-bs-target="#tab-social-login"
                                        type="button" role="tab">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" data-bs-toggle="tab" data-bs-target="#tab-cookie" type="button"
                                        role="tab">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade show active" id="tab-general" role="tabpanel">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-12">
                                            <div class="form-section-title"><i class="fas fa-image"></i> Logo & Favicon
                                            </div>
                                        </div>
                                            ...
                                            <div class="image-upload-wrapper" id="logoWrapper"
                                                ...
                                                <div class="image-preview" id="logoPreview">
                                                    <i class="fas fa-image fa-3x text-muted placeholder-icon"
                                                        id="logoPlaceholderIcon"></i>
                                                    <p class="text-muted small mt-2 placeholder-text"
                                                        id="logoPlaceholderText">Click to upload logo</p>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="image-upload-wrapper" id="faviconWrapper"
                                                onclick="document.getElementById('faviconInput').click()">
                                                <div class="image-preview" id="faviconPreview">
                                                    <i class="fas fa-image fa-3x text-muted placeholder-icon"
                                                        id="faviconPlaceholderIcon"></i>
                                                    <p class="text-muted small mt-2 placeholder-text"
                                                        id="faviconPlaceholderText">Click to upload favicon</p>
                                                    <img id="faviconPreviewImg" src="#" alt="Preview" class="preview-image">
                                                </div>
                                                <input type="file" id="faviconInput" accept="image/*"
                                                    onchange="uploadImage(this, 'favicon')">
                                                <button type="button" class="remove-image-btn" id="removeFaviconBtn"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <select name="timezone" class="form-select">
                                                ...
                                                <option value="America/New_York" {{ ($settings->timezone ?? '') == 'America/New_York' ? 'selected' : '' }}>America/New York (EST)
                                                </option>
                                ...
                                <div class="tab-pane fade" id="tab-social" role="tabpanel">
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label"><i class="fab fa-facebook text-primary"></i>
                                                Facebook</label>
                                            <input type="url" name="facebook" class="form-control"
                                                value="{{ old('facebook', $settings->facebook ?? '') }}">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label"><i class="fab fa-twitter text-info"></i>
                                                Twitter</label>
                                            <input type="url" name="twitter" class="form-control"
                                                value="{{ old('twitter', $settings->twitter ?? '') }}">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label"><i class="fab fa-instagram text-danger"></i>
                                                Instagram</label>
                                            <input type="url" name="instagram" class="form-control"
                                                value="{{ old('instagram', $settings->instagram ?? '') }}">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label"><i class="fab fa-linkedin text-primary"></i>
                                                LinkedIn</label>
                                            <input type="url" name="linkedin" class="form-control"
                                                value="{{ old('linkedin', $settings->linkedin ?? '') }}">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label"><i class="fab fa-youtube text-danger"></i>
                                                YouTube</label>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label"><i class="fab fa-pinterest text-danger"></i>
                                                Pinterest</label>
                                            <input type="url" name="pinterest" class="form-control"
                                                value="{{ old('pinterest', $settings->pinterest ?? '') }}">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label"><i class="fab fa-telegram text-primary"></i>
                                                Telegram</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            <div class="form-check form-switch">
                                                <input type="checkbox" name="ads_enabled" class="form-check-input"
                                                    id="adsEnabled" value="1" {{ old('ads_enabled', $settings->ads_enabled ?? false) ? 'checked' : '' }}>
                                                <label class="form-check-label fw-bold" for="adsEnabled">Enable Ads</label>
                                            </div>
                                        </div>
                                        <div class="col-12 mb-3">
                                            <label class="form-label">Header Ad Code</label>
                                            <textarea name="header_ad_code" class="form-control"
                                                rows="3">{{ old('header_ad_code', $settings->header_ad_code ?? '') }}</textarea>
                                        </div>
                                        <div class="col-12 mb-3">
                                            <label class="form-label">Sidebar Ad Code</label>
                                            <textarea name="sidebar_ad_code" class="form-control"
                                                rows="3">{{ old('sidebar_ad_code', $settings->sidebar_ad_code ?? '') }}</textarea>
                                        </div>
                                        <div class="col-12 mb-3">
                                            <label class="form-label">Footer Ad Code</label>
                                            <textarea name="footer_ad_code" class="form-control"
                                                rows="3">{{ old('footer_ad_code', $settings->footer_ad_code ?? '') }}</textarea>
                                        </div>
                                        <div class="col-12 mb-3">
                                            <label class="form-label">In-Content Ad Code</label>
                                            <textarea name="in_content_ad_code" class="form-control"
                                                rows="3">{{ old('in_content_ad_code', $settings->in_content_ad_code ?? '') }}</textarea>
                                        </div>
                                        <div class="col-12 mb-3">
                                            <label class="form-label">Popup Ad Code</label>
                                            <textarea name="popup_ad_code" class="form-control"
                                                rows="3">{{ old('popup_ad_code', $settings->popup_ad_code ?? '') }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane fade" id="tab-captcha" role="tabpanel">
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            <div class="form-check form-switch">
                                                <input type="checkbox" name="captcha_enabled" class="form-check-input"
                                                    id="captchaEnabled" value="1" {{ old('captcha_enabled', $settings->captcha_enabled ?? false) ? 'checked' : '' }}>
                                                <label class="form-check-label fw-bold" for="captchaEnabled">Enable
                                                    Captcha</label>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <div class="form-check form-switch">
                                                <input type="checkbox" name="captcha_on_login" class="form-check-input"
                                                    id="captchaLogin" value="1" {{ old('captcha_on_login', $settings->captcha_on_login ?? false) ? 'checked' : '' }}>
                                                <label class="form-check-label" for="captchaLogin">On Login</label>
                                            </div>
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            <div class="form-check form-switch">
                                                <input type="checkbox" name="captcha_on_register" class="form-check-input"
                                                    id="captchaRegister" value="1" {{ old('captcha_on_register', $settings->captcha_on_register ?? false) ? 'checked' : '' }}>
                                                <label class="form-check-label" for="captchaRegister">On Register</label>
                                            </div>
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            <div class="form-check form-switch">
                                                <input type="checkbox" name="captcha_on_contact" class="form-check-input"
                                                    id="captchaContact" value="1" {{ old('captcha_on_contact', $settings->captcha_on_contact ?? false) ? 'checked' : '' }}>
                                ...
                                <div class="tab-pane fade" id="tab-social-login" role="tabpanel">
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            <div class="form-check form-switch">
                                                <input type="checkbox" name="social_login_enabled" class="form-check-input"
                                                    id="socialLoginEnabled" value="1" {{ old('social_login_enabled', $settings->social_login_enabled ?? false) ? 'checked' : '' }}>
                                                <label class="form-check-label fw-bold" for="socialLoginEnabled">Enable
                                                    Social Login</label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <div class="form-check form-switch">
                                                <input type="checkbox" name="facebook_login" class="form-check-input"
                                                    id="fbLogin" value="1" {{ old('facebook_login', $settings->facebook_login ?? false) ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <div class="form-check form-switch">
                                                <input type="checkbox" name="google_login" class="form-check-input"
                                                    id="googleLogin" value="1" {{ old('google_login', $settings->google_login ?? false) ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <div class="form-check form-switch">
                                                <input type="checkbox" name="linkedin_login" class="form-check-input"
                                                    id="linkedinLogin" value="1" {{ old('linkedin_login', $settings->linkedin_login ?? false) ? 'checked' : '' }}>
                                ...
                                <div class="tab-pane fade" id="tab-payments" role="tabpanel">
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            <div class="form-check form-switch">
                                                <input type="checkbox" name="payment_enabled" class="form-check-input"
                                                    id="paymentEnabled" value="1" {{ old('payment_enabled', $settings->payment_enabled ?? false) ? 'checked' : '' }}>
                                                <label class="form-check-label fw-bold" for="paymentEnabled">Enable
                                                    Payments</label>
                                            </div>
                                        </div>
                                        <div class="col-md-12 mb-2">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <div class="form-check form-switch">
                                                <input type="checkbox" name="easypaisa_enabled" class="form-check-input"
                                                    id="easypaisaEnabled" value="1" {{ old('easypaisa_enabled', $settings->easypaisa_enabled ?? false) ? 'checked' : '' }}>
                                                <label class="form-check-label" for="easypaisaEnabled">Enable</label>
                                            </div>
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            <label class="form-label">Merchant ID</label>
                                            <input type="text" name="easypaisa_merchant_id" class="form-control"
                                                value="{{ old('easypaisa_merchant_id', $settings->easypaisa_merchant_id ?? '') }}">
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            <label class="form-label">API Key</label>
                                            <input type="text" name="easypaisa_api_key" class="form-control"
                                                value="{{ old('easypaisa_api_key', $settings->easypaisa_api_key ?? '') }}">
                                        </div>
                                        <div class="col-md-12 mb-2">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <div class="form-check form-switch">
                                                <input type="checkbox" name="jazzcash_enabled" class="form-check-input"
                                                    id="jazzcashEnabled" value="1" {{ old('jazzcash_enabled', $settings->jazzcash_enabled ?? false) ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" name="jazzcash_merchant_id" class="form-control"
                                                value="{{ old('jazzcash_merchant_id', $settings->jazzcash_merchant_id ?? '') }}">
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            <label class="form-label">API Key</label>
                                            <input type="text" name="jazzcash_api_key" class="form-control"
                                                value="{{ old('jazzcash_api_key', $settings->jazzcash_api_key ?? '') }}">
                                        </div>
                                        <div class="col-md-12 mb-2">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <div class="form-check form-switch">
                                                <input type="checkbox" name="paypal_enabled" class="form-check-input"
                                                    id="paypalEnabled" value="1" {{ old('paypal_enabled', $settings->paypal_enabled ?? false) ? 'checked' : '' }}>
                                                <label class="form-check-label" for="paypalEnabled">Enable</label>
                                            </div>
                                        </div>
                                        <div class="col-md-3 mb-3">
                                            <div class="form-check form-switch">
                                                <input type="checkbox" name="paypal_sandbox" class="form-check-input"
                                                    id="paypalSandbox" value="1" {{ old('paypal_sandbox', $settings->paypal_sandbox ?? true) ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <div class="form-check form-switch">
                                                <input type="checkbox" name="stripe_enabled" class="form-check-input"
                                                    id="stripeEnabled" value="1" {{ old('stripe_enabled', $settings->stripe_enabled ?? false) ? 'checked' : '' }}>
                                ...
                                <div class="tab-pane fade" id="tab-analytics" role="tabpanel">
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            <div class="form-check form-switch">
                                                <input type="checkbox" name="analytics_enabled" class="form-check-input"
                                                    id="analyticsEnabled" value="1" {{ old('analytics_enabled', $settings->analytics_enabled ?? false) ? 'checked' : '' }}>
                                                <label class="form-check-label fw-bold" for="analyticsEnabled">Enable
                                                    Analytics</label>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" name="analytics_property_id" class="form-control"
                                                value="{{ old('analytics_property_id', $settings->analytics_property_id ?? '') }}"
                                                placeholder="UA-XXXXXXXXX-X">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label">API Key</label>
                                            <input type="text" name="analytics_api_key" class="form-control"
                                                value="{{ old('analytics_api_key', $settings->analytics_api_key ?? '') }}">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="form-check form-switch mt-4">
                                                <input type="checkbox" name="analytics_anonymize_ip"
                                                    class="form-check-input" id="anonymizeIp" value="1" {{ old('analytics_anonymize_ip', $settings->analytics_anonymize_ip ?? true) ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-12 mb-3">
                                            <div class="form-check form-switch">
                                                <input type="checkbox" name="cookie_consent_enabled"
                                                    class="form-check-input" id="cookieEnabled" value="1" {{ old('cookie_consent_enabled', $settings->cookie_consent_enabled ?? true) ? 'checked' : '' }}>
                                                <label class="form-check-label fw-bold" for="cookieEnabled">Enable Cookie
                                                    Consent</label>
                                            </div>
                                        </div>
                                        <div class="col-12 mb-3">
                                            <label class="form-label">Cookie Message</label>
                                            <textarea name="cookie_consent_message" class="form-control"
                                                rows="3">{{ old('cookie_consent_message', $settings->cookie_consent_message ?? '') }}</textarea>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label">Cookie Policy URL</label>
                                            <input type="url" name="cookie_policy_url" class="form-control"
                                                value="{{ old('cookie_policy_url', $settings->cookie_policy_url ?? '') }}">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label">Cookie Expiry (Days)</label>
                                            <input type="number" name="cookie_expiry_days" class="form-control"
                                                value="{{ old('cookie_expiry_days', $settings->cookie_expiry_days ?? 365) }}"
                                                min="1" max="730">
                                        </div>
                                    </div>
                                </div>

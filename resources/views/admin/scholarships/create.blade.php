                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="degree_level"
                                            ...
                                            <option value="Master" {{ old('degree_level') == 'Master' ? 'selected' : '' }}>
                                                Master</option>
                                            <option value="M.Phil" {{ old('degree_level') == 'M.Phil' ? 'selected' : '' }}>
                                                M.Phil</option>
                                            <option value="PhD" {{ old('degree_level') == 'PhD' ? 'selected' : '' }}>PhD
                                            </option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="source" class="form-select @error('source') is-invalid @enderror">
                                            ...
                                            <option value="official" {{ old('source') == 'official' ? 'selected' : '' }}>
                                                Official</option>

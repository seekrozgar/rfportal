...
@section('page-subtitle', 'Update job posting')
                ...
                <div class="card shadow-sm border-0">
                    <div
                        ...
                        <h5 class="mb-0 fw-bold">
                            <i class="fas fa-edit me-2 text-primary"></i> Edit Job
                        </h5>
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.job-postings.update', $job->id) }}" method="POST"
                            enctype="multipart/form-data" id="jobForm" novalidate>
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 mb-3">
                                    ...
                                    <input type="text" name="title"
                                        ...
                                        placeholder="e.g. Assistant Director (BS-17)" required>
                                    @error('title')
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select name="job_type_id"
                                        class="form-select @error('job_type_id') is-invalid @enderror" required>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select name="job_shift_id"
                                        class="form-select @error('job_shift_id') is-invalid @enderror">
                                        <option value="">Select Job Shift</option>
                                        @foreach($jobShifts as $shift)
                                            <option value="{{ $shift->id }}" {{ old('job_shift_id', $job->job_shift_id) == $shift->id ? 'selected' : '' }}>
                                                {{ $shift->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" name="location"
                                        ...
                                        value="{{ old('location', $job->location) }}" placeholder="e.g. Lahore, Pakistan"
                                        required>
                                    @error('location')
                                    <div class="invalid-feedback show">{{ $message }}</div>@enderror
                                </div>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <select name="experience_level_id"
                                        class="form-select @error('experience_level_id') is-invalid @enderror">
                                        <option value="">Select Experience</option>
                                        @foreach($experienceLevels as $level)
                                            <option value="{{ $level->id }}" {{ old('experience_level_id', $job->experience_level_id) == $level->id ? 'selected' : '' }}>
                                                {{ $level->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <select name="career_level_id"
                                        class="form-select @error('career_level_id') is-invalid @enderror">
                                        <option value="">Select Career Level</option>
                                        @foreach($careerLevels as $level)
                                            <option value="{{ $level->id }}" {{ old('career_level_id', $job->career_level_id) == $level->id ? 'selected' : '' }}>
                                                {{ $level->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <select name="functional_area_id"
                                        class="form-select @error('functional_area_id') is-invalid @enderror">
                                        <option value="">Select Functional Area</option>
                                        @foreach($functionalAreas as $area)
                                            <option value="{{ $area->id }}" {{ old('functional_area_id', $job->functional_area_id) == $area->id ? 'selected' : '' }}>
                                                {{ $area->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <select name="degree_level_id"
                                        class="form-select @error('degree_level_id') is-invalid @enderror">
                                        <option value="">Select Degree Level</option>
                                        @foreach($degreeLevels as $level)
                                            <option value="{{ $level->id }}" {{ old('degree_level_id', $job->degree_level_id) == $level->id ? 'selected' : '' }}>
                                                {{ $level->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <select name="degree_type_id"
                                        class="form-select @error('degree_type_id') is-invalid @enderror">
                                        <option value="">Select Degree Type</option>
                                        @foreach($degreeTypes as $type)
                                            <option value="{{ $type->id }}" {{ old('degree_type_id', $job->degree_type_id) == $type->id ? 'selected' : '' }}>
                                                {{ $type->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <select name="major_subject_id"
                                        class="form-select @error('major_subject_id') is-invalid @enderror">
                                        <option value="">Select Major Subject</option>
                                        @foreach($majorSubjects as $subject)
                                            <option value="{{ $subject->id }}" {{ old('major_subject_id', $job->major_subject_id) == $subject->id ? 'selected' : '' }}>
                                                {{ $subject->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <select name="marital_status_id"
                                        class="form-select @error('marital_status_id') is-invalid @enderror">
                                        <option value="">Select Marital Status</option>
                                        @foreach($maritalStatuses as $status)
                                            <option value="{{ $status->id }}" {{ old('marital_status_id', $job->marital_status_id) == $status->id ? 'selected' : '' }}>
                                                {{ $status->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <select name="language_level_id"
                                        class="form-select @error('language_level_id') is-invalid @enderror">
                                        <option value="">Select Language Level</option>
                                        @foreach($languageLevels as $level)
                                            <option value="{{ $level->id }}" {{ old('language_level_id', $job->language_level_id) == $level->id ? 'selected' : '' }}>
                                                {{ $level->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                {{-- Salary Information --}}
                                <div class="col-12 mb-3 mt-2">
                                    <div class="form-section-title"><i class="fas fa-money-bill-wave"></i> Salary
                                        Information</div>
                                </div>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select name="salary_period_id"
                                        class="form-select @error('salary_period_id') is-invalid @enderror">
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        @php
                                            ...
                                            $existingJobImage = $job->advertisement_image ?? null;
                                            $existingJobImageUrl = $existingJobImage && $existingJobImage !== 'images/no-image-icon-15.png'
                                                ? \Illuminate\Support\Facades\Storage::url($existingJobImage)
                                                : $defaultJobImage;
                                        ...
                                        <div class="image-upload-wrapper @error('advertisement_image') border-danger @enderror"
                                            ...
                                            <div class="image-preview" id="imagePreview">
                                                ...
                                                <img id="previewImage" src="{{ $existingJobImageUrl }}"
                                                    data-default-src="{{ $existingJobImageUrl }}" alt="Job image"
                                                ...
                                                <i class="fas fa-image fa-3x text-muted placeholder-icon"
                                                    id="placeholderIcon" style="display:none;"></i>

                                                <p class="text-muted small mt-2 placeholder-text" id="placeholderText"
                                                    style="display:none;">
                                                    Click to upload image
                                                </p>
                                            </div>

                                            <input type="file" name="advertisement_image" id="featuredImage"
                                            ...
                                            <input type="hidden" name="advertisement_image_default"
                                                id="advertisementImageDefault"
                                                value="{{ old('advertisement_image_default', $job->advertisement_image ?: $defaultJobImageName) }}">

                                            <button type="button" class="remove-image-btn" id="removeImage"
                                                title="Use default image" aria-label="Use default image">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <textarea name="benefits" class="form-control @error('benefits') is-invalid @enderror"
                                        id="benefitsEditor" rows="4">{{ old('benefits', $job->benefits) }}</textarea>
                                    @error('benefits')
                                    <div class="invalid-feedback show">{{ $message }}</div>@enderror
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <textarea name="skills_required"
                                        ...
                                        rows="3">{{ old('skills_required', $job->skills_required) }}</textarea>
                                ...
                                {{-- Application Details --}}
                                <div class="col-12 mb-3 mt-2">
                                    <div class="form-section-title"><i class="fas fa-envelope"></i> Application Details
                                    </div>
                                </div>

                                <div class="col-12 mb-3">
                                    <label class="form-label">Application Instructions</label>
                                    <textarea name="application_instructions"
                                        class="form-control @error('application_instructions') is-invalid @enderror"
                                        rows="2">{{ old('application_instructions', $job->application_instructions) }}</textarea>
                                ...
                                {{-- Deadline & Status --}}
                                <div class="col-12 mb-3 mt-2">
                                    <div class="form-section-title"><i class="fas fa-calendar-alt"></i> Deadline & Status
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="row g-2">
                                        <div class="col-6">
                                            <div class="form-check form-switch">
                                                <input type="checkbox" name="is_active" class="form-check-input"
                                                    id="isActive" value="1" {{ old('is_active', $job->is_active) ? 'checked' : '' }}>
                                        ...
                                        <div class="col-6">
                                            <div class="form-check form-switch">
                                                <input type="checkbox" name="is_urgent" class="form-check-input"
                                                    id="isUrgent" value="1" {{ old('is_urgent') ? 'checked' : '' }}>
                                        ...
                                        <div class="col-6">
                                            <div class="form-check form-switch">
                                                <input type="checkbox" name="is_remote" class="form-check-input"
                                                    id="isRemote" value="1" {{ old('is_remote') ? 'checked' : '' }}>
                                        ...
                                        <div class="col-6">
                                            <div class="form-check form-switch">
                                                <input type="checkbox" name="is_fresh" class="form-check-input" id="isFresh"
                                                    value="1" {{ old('is_fresh') ? 'checked' : '' }}>
    ...
    @push('scripts')
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                // Edit page: keep the saved real image if one exists.
                // Otherwise use the permanent default image.
                const existingRealImage = previewImage && previewImage.dataset.existingReal === '1';

                if (existingRealImage) {
                    showRealImage(previewImage.src);
                } else {
                    showDefaultImage();
                }
